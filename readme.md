...
制作に至った過程として、インターン先で使われていた管理画面を取り入れようとしたことまた、音楽を聴くのが好きという２点がこのアプリケーションを作る理由になりました。機能としては知りたい曲のタイトルを調べることで、その曲の歌詞をみたり、コメントやいいねを送り合ってコミニュケーションを取ることが可能です。 他の機能一覧については下記に記しました。
